				...
				if(block.reprise != undefined){
					...
					if(block.is_practice){
						...
						block.timeline = Percept.intersperse({
							timeline : stimuli,
							trial: {type: 'text', cont_key: [], text: "You can now take a break, press any key to continue / Vous pouvez prendre une pause, appuyez sur n'importe quelle touche pour continuer"},
